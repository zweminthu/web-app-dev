...
$cnt=$query->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileinfo">
							...
							<div class="four-text">
								<h3>Categories</h3>
										<?php $sql1 = "SELECT CatId from category";
$query1 = $dbp -> prepare($sql1);
$query1->execute();
...
$cnt1=$query1->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							...
							<div class="four-text">
								<h3>Items</h3>
																	<?php $sql3 = "SELECT ItemId from item";
$query3= $dbp -> prepare($sql3);
$query3->execute();
...
$cnt3=$query3->rowCount();
					...
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Enquiries</h3>
												<?php $sql2 = "SELECT EnquireId from enquire";
$query2= $dbp -> prepare($sql2);
$query2->execute();
...
<div class="four-grids">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							...
							<div class="four-text">
								<h3>Orders</h3>
												<?php $sql5 = "SELECT * FROM `order`";
$query5= $dbp -> prepare($sql5);
$query5->execute();
					...
					<div class="col-md-3 four-grid">
						<div class="four-agileits">
							...
							<div class="four-text">
								...
								<?php $sql6 = "SELECT MId from message";
$query6 = $dbp -> prepare($sql6);
$query6->execute();
