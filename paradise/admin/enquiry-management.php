...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    if(isset($_REQUEST['eid']))
    {
        ...
        $sql = "UPDATE enquire SET Action=:status WHERE  EnquireId=:eid";
...
<html>
<head>
<title>Paradise | Admin manage Enquires</title>
...
{				?>		
						  <tr>
							<td width="120"><?php echo htmlentities($result->EnquireId);?></td>
							<td width="50"><?php echo htmlentities($result->Name);?></td>
							<td width="50"><?php echo htmlentities($result->Email);?> </td>
								<td width="50"><?php echo htmlentities($result->MobileNo);?> </td>
...
<td><a href="enquiry-management.php?eid=<?php echo htmlentities($result->EnquireId);?>" onclick="return confirm('Do you really want to read')" >Pending</a>
</td>
<?php } ?>
</tr>
						 <?php } }?>
