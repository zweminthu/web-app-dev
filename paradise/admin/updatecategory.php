...
if(isset($_POST['update']))
{
    ...
    $sql="UPDATE  category SET CatName=:cname where CatId=:cid";
    ...
    if($lastInsertId)
    {
        $_SESSION['msg']="Updating Category Scuccessfully.";
	   ...
	   <div class="mother-grid-inner">
            <!--header start here-->
				...
				<div class="clearfix"> </div>	
				   	...
				   	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i><a href="category-management.php">Manage Category</a><i class="fa fa-angle-right"></i>Update Category </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
{	?>
							<form class="form-horizontal" name="category" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="catname" placeholder=" Category Name" required>
									</div>
								</div>
