...
if(isset($_POST['add']))
{
    ...
    if($lastInsertId)
    {
        $_SESSION['msg']="Adding New Category Scuccessfully.";
	   ...
	   <div class="mother-grid-inner">
            <!--header start here-->
				...
				<div class="clearfix"> </div>	
				   	...
				   	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i><a href="category-management.php">Manage Category</a><i class="fa fa-angle-right"></i>Create Category </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="category" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="catname" placeholder="Create New Category" required>
									</div>
								</div>
